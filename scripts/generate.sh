...
#SBATCH --output="/media/nhdang/Vy_Cat/newPCMDM/scripts/log_out/generate/dhms.out"
#SBATCH --error="/media/nhdang/Vy_Cat/newPCMDM/scripts/log_out/generate/dhms.err"
#SBATCH --nodes=1
