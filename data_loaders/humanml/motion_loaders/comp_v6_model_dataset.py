            ...
            for i, batch in tqdm(enumerate(dataloader)):
                ...
                for t in range(repeat_times):
                    ...
                    for idx in range(bs):
                        ...
                        assert motion_0_result.shape == motion_1_result.shape == (1, 75, nfeats)
                        assert motion_2_result.shape == (1, 30, nfeats)
                        
                        # motion_result = torch.cat((motion_0_result, motion_1_result), dim=0)
                        motion_result = torch.cat((motion_0_result, motion_2_result, motion_1_result), dim=1)
