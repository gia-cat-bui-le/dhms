...
from utils.utils import extract, make_beta_schedule
...
class GaussianDiffusion():
    ...
    def p_mean_variance_comp(
        self, hist_frames, model, x, t, clip_denoised=True, denoised_fn=None, model_kwargs_0=None, model_kwargs_1=None, inter_frames=None,
    ):
        ...
        output_1 = model(x_1, self._scale_timesteps(t), **model_kwargs_1)
        model_output = get_canavas(output_0, model_kwargs_0['y'], output_1, model_kwargs_1['y'], inter_frames)
    ...
    def training_losses(self, model, x_start, t, model_kwargs=None, noise=None, dataset=None):
        ...
        if model_kwargs is None:
            model_kwargs = {}
        #TODO: fix this for repetitive noise
        if noise is None:
            noise = th.randn_like(x_start)
    ...
    def training_losses_multi(self, model, x_start, t, model_kwargs=None, noise=None, dataset=None):
        """
        Compute training losses for a single timestep.
