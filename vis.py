...
def plot_single_pose(num, poses, lines, ax, axrange, scat, contact):
    ...
    if num == 0:
        ...
        xcenter, ycenter, zcenter = 0, 0, 2.0
...
if __name__ == '__main__':
    with open('evaluation\inference\gBR_sBM_cAll_d04_mBR0_ch02_slice1.pkl', 'rb') as f:
        data = pickle.load(f)
    ...
    render_out = "renders"
    epoch = 0
    name = "evaluation\inference\gBR_sBM_cAll_d04_mBR0_ch02_slice1.pkl"
    sound = False
    render = True
    sound_folder = ""
    skeleton_render_3D(
